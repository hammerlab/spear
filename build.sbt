...
libraryDependencies ++= List(
  "org.mongodb" % "casbah-core_2.10" % "2.7.1",
  "org.mongodb" % "casbah-commons_2.10" % "2.7.1",
  ("org.apache.spark" % "spark-core_2.10" % "1.3.1") % "provided", //.exclude("com.esotericsoftware.minlog", "minlog"),
